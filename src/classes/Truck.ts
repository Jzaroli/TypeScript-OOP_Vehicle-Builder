...
// extends the Vehicle class and should implement the AbleToTow interface
class Truck extends Vehicle implements AbleToTow {
  ...
  tow(vehicle: Truck | Motorbike | Car): void {
    // gets the make and model of the vehicle if it exists
    if (this.make && this.model){
    // checks if the vehicle's weight is less than or equal to the truck's towing capacity
    // if it is, logs that the vehicle is being towed; if it is not, logs that the vehicle is too heavy to be towed
