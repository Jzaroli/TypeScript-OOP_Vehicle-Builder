...
class Truck extends Vehicle {
    ...
    tow(vehicle) {
        ...
        if (this.make && this.model) {
            ...
            if (this.weight <= this.towingCapacity) {
                ...
                console.log(`This ${vehicle.make} ${vehicle.model} is too heavy to tow.`);
            }
        }
    }
    ...
    // TODO: The details should include the VIN, color, make, model, year, weight, top speed, towing capacity, and wheels
    printDetails() {
